                ...
                <div className="row justify-content-center">             
                    ...
                    <div className="col-7 col-sm-5">
                        ...
                        <address>
                          ...
                          HONG KONG<br />
                          <i className="fa fa-phone fa-lg mr-2"></i>: +852 1234 5678<br />
                          <i className="fa fa-fax fa-lg mr-2"></i>: +852 8765 4321<br />
                          <i className="fa fa-envelope fa-lg mr-2"></i>: <a href="mailto:confusion@food.net">
